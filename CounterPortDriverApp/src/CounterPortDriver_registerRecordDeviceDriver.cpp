...
/* Generated from CounterPortDriver.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiGeneralTime, *pvar_dset_devAiHP3458AGpib,
    ...
    *pvar_dset_devAoSoftCallback, *pvar_dset_devAoHP3458AGpib,
    ...
    *pvar_dset_devBiHP3458AGpib, *pvar_dset_asynBiInt32,
    ...
    *pvar_dset_devBoHP3458AGpib, *pvar_dset_asynBoInt32,
    ...
    *pvar_dset_devLiHP3458AGpib, *pvar_dset_asynLiInt32,
    ...
    *pvar_dset_devMbbiSoftCallback, *pvar_dset_devMbbiHP3458AGpib,
    ...
    *pvar_dset_devMbboHP3458AGpib, *pvar_dset_asynMbboInt32,
    ...
    *pvar_dset_devSiHP3458AGpib, *pvar_dset_asynSiOctetCmdResponse,
    *pvar_dset_asynSiOctetWriteRead, *pvar_dset_asynSiOctetRead,
    *pvar_dset_devSoSoft, *pvar_dset_devSoSoftCallback,
    *pvar_dset_devSoStdio, *pvar_dset_devSoHP3458AGpib,
...
static const char * const deviceSupportNames[] = {
    ...
    "devAiHP3458AGpib", "asynAiInt32", "asynAiInt32Average",
    "asynAiFloat64", "asynAiFloat64Average", "asynAiInt64", "devAoSoft",
    "devAoSoftRaw", "devAoSoftCallback", "devAoHP3458AGpib",
    "asynAoInt32", "asynAoFloat64", "asynAoInt64", "asynRecordDevice",
    "devBiSoft", "devBiSoftRaw", "devBiSoftCallback", "devBiDbState",
    "devBiHP3458AGpib", "asynBiInt32", "asynBiUInt32Digital", "devBoSoft",
    "devBoSoftRaw", "devBoSoftCallback", "devBoGeneralTime",
    "devBoDbState", "devBoHP3458AGpib", "asynBoInt32",
    "asynBoUInt32Digital", "devCalcoutSoft", "devCalcoutSoftCallback",
    ...
    "devLiSoftCallback", "devLiGeneralTime", "devLiHP3458AGpib",
    ...
    "devMbbiSoftCallback", "devMbbiHP3458AGpib", "asynMbbiInt32",
    ...
    "devMbboHP3458AGpib", "asynMbboInt32", "asynMbboUInt32Digital",
    ...
    "devSiHP3458AGpib", "asynSiOctetCmdResponse", "asynSiOctetWriteRead",
    "asynSiOctetRead", "devSoSoft", "devSoSoftCallback", "devSoStdio",
    "devSoHP3458AGpib", "asynSoOctetWrite", "devSASoft", "devWfSoft",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devAiHP3458AGpib, pvar_dset_asynAiInt32,
    ...
    pvar_dset_devBiDbState, pvar_dset_devBiHP3458AGpib,
    ...
    pvar_dset_devBoDbState, pvar_dset_devBoHP3458AGpib,
    ...
    pvar_dset_devLiGeneralTime, pvar_dset_devLiHP3458AGpib,
    ...
    pvar_dset_devMbbiHP3458AGpib, pvar_dset_asynMbbiInt32,
...
epicsShareExtern reg_func pvar_func_CounterDriverRegister,
    pvar_func_FlipCoilDriverRegister, pvar_func_GetterDriverRegister,
    pvar_func_WaterDriverRegister, pvar_func_arrInitialize,
    ...
    pvar_func_integralCalcRegister, pvar_func_rsrvRegistrar,
...
epicsShareExtern int * const pvar_int_dbLoadSuspendOnError;
...
static struct iocshVarDef vardefs[] = {
    ...
    {"dbLoadSuspendOnError", iocshArgInt, pvar_int_dbLoadSuspendOnError},
...
int CounterPortDriver_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/sdf/home/l/lujko/AbendFlipCoil";
    ...
    pvar_func_CounterDriverRegister();
    pvar_func_FlipCoilDriverRegister();
    pvar_func_GetterDriverRegister();
    pvar_func_WaterDriverRegister();
    ...
    pvar_func_drvAsynIPPortRegisterCommands();
    pvar_func_drvAsynIPServerPortRegisterCommands();
    pvar_func_integralCalcRegister();
...
/* CounterPortDriver_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"CounterPortDriver_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(CounterPortDriver_registerRecordDeviceDriver(*iocshPpdbbase));
}
